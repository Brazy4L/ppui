...
export default function Sidebar({
  ...
  return (
    <nav className="top-20 flex flex-col gap-2 rounded-lg border-8 border-light-bg-alternative p-4 font-semibold dark:border-dark-bg-alternative lg:sticky lg:h-[calc(100vh-6rem-1px)]">
