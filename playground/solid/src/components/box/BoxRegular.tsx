...
export default function Box() {
  ...
  return (
    <div class="max-w-xl">
      <p class={more() ? '' : 'line-clamp-3 '}>{text}</p>
      <button
        class="mt-4 flex w-full justify-center rounded-lg bg-light-bg-secondary p-3 font-semibold transition-colors hover:bg-light-bg-alternative dark:bg-dark-bg-secondary dark:hover:bg-dark-bg-alternative"
